    ...
    function _fnKey(e) {
        ...
        switch (iKey) {
            case 13: /* return */
                ...
                //document.getElementById("txtONhapDuLieu").select();
                //return true;
                //return false;
            ...
            case 33: /* page up */
                if (_iOldY > iRecordPerPage) {
                    x = _iOldX;
                    y = _iOldY - iRecordPerPage;
                } else {
                    if (_iOldY > 0) {
                        x = _iOldX;
                        y = 0;
            ...
            case 34: /* page down */
                if (_iOldY < iTableHeight - iRecordPerPage - 1) {
                    x = _iOldX;
                    y = _iOldY + iRecordPerPage;
                } else {
                    if (_iOldY < iTableHeight - 1) {
            ...
            default: /* Nothing we are interested in */
                ...
                if ((48 <= MaKhoa && MaKhoa <= 58) || (65 <= MaKhoa && MaKhoa <= 90) || (97 <= MaKhoa && MaKhoa <= 122)) {
                    //Nhập số
                    //sKyTuVuaNhap = String.fromCharCode(MaKhoa);
                }
                _fnEventFire("action", _iOldX, _iOldY);
                return true;
        }
    ...
    */
    function _fnCellFromCoords(x, y) {
        if (_oDatatable) {
            ...
            if (sEnterPressed) {
                sEnterPressed = false;
                jQuery('tr:eq(' + y + ')>td:eq(' + x + ')', _nBody)[0].innerHTML = '';
            }
