...
namespace DATA0200026
{
    public class HoSo26Models
    {
        ...
        public string sToChuc_DiaChi { get; set; }
        public string sToChuc_Tel { get; set; }
        public string sToChuc_Fax { get; set; }
        public string sToChuc_Email { get; set; }
        public string sMaCoQuanXuLy { get; set; }
        public string sTenCoQuanXuLy { get; set; }
        public string sKyHoSo_MaTinh { get; set; }
