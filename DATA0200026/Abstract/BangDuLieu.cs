...
{
    public class BangDuLieu_ThongTinCot
    {
        public String MaCot = "";
        public String Text = "";
        public int DoRong = 0;
        public Boolean HienThi = true;
        public Boolean DuocNhapDuLieu = false;
        public String Align = "";
        public String Type = "0";
        public String Class = "";
        public String NhomTieuDe = "";
        public int NhomSoCot = 0;

        public BangDuLieu_ThongTinCot(String MaCot = "", String Text = "", int DoRong = 0, Boolean HienThi = true, Boolean DuocNhapDuLieu = false, String Align = "", String Type = "", String Class = "", String NhomTieuDe="", int NhomSoCot = 1)
        {
            this.MaCot = MaCot;
            this.Text = Text;
            this.DoRong = DoRong;
            this.HienThi = HienThi;
            this.DuocNhapDuLieu = DuocNhapDuLieu;
            if (Align == "")
            {
                if (MaCot.StartsWith("b"))
                {
                    //Nhap Kieu checkbox
                    Align = "center";
                }
                else if (MaCot.StartsWith("r") || (MaCot.StartsWith("iID") == false && MaCot.StartsWith("i")))
                {
                    //Nhap Kieu so
                    Align = "right";
                }
            ...
            if (Type == "")
            {
                ...
                else if (MaCot.StartsWith("d"))
                {
                    //Nhap Kieu ngay thang nam
                    Type = "4";
                }
            }
            this.Type = Type;
            ...
            this.NhomTieuDe = NhomTieuDe;
            this.NhomSoCot = NhomSoCot;
        }
    }
    ...
    public class BangDuLieu
    {
        ...
        protected List<String> _arrClassCot = null;
        ...
        public string iID_Ma { get { return _iID_Ma; } }
        ...
        public List<String> arrClassCot
        {
            get
            {
                if (_arrClassCot == null)
                {
                    _arrClassCot = new List<String>();
                    for (int j = 0; j < arrDSMaCot.Count; j++)
                    {
                        _arrClassCot.Add("");
                    }
        ...
        public string strDSClassCot
        {
            get
            {
                String vR = "";
                StringBuilder builder = new StringBuilder();
                for (int i = 0; i < arrClassCot.Count; i++)
                {
                    if (i > 0) builder.Append(String.Format("{0}", ",")); //vR += ",";
                    builder.Append(_arrClassCot[i]); //vR += (arrHienThiCot[i]) ? "1" : "0";
                }
                vR = builder.ToString();
                return vR;
            }
        ...
        {
            String[] arrDSTruongAutocomplete = ("sTenDonVi,iID_MaDonVi,sLNS,sL,sK,sM,sTM,sTTM,sNG,sTNG," +
                                                "sTenCongTrinh,sTenTaiSan,sTenPhongBan").Split(',');
