...
namespace APP0200025.Controllers
{
    public class LanhDaoCucController : Controller
    {
        ...
        public ActionResult Duyet(String ParentID)
        {
            ...
            clLichSuHoSo.InsertLichSu(User.Identity.Name, (int)clDoiTuong.DoiTuong.LanhDaoCuc, (int)clHanhDong.HanhDong.DongYXacNhanGDK, "Đồng ý xác nhận GĐK", "", hoSo.iID_MaTrangThai, trangThaiTiepTheo.iID_MaTrangThai);
