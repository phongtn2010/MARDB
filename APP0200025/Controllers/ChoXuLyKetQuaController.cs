                ...
                for (int i = 0; i < files.Count; i++)
                {
                    ...
                    if (postedFile != null && postedFile.ContentLength > 0)
                    {
                        if (CommonFunction.FileUploadCheck(postedFile))
                        {
                            ...
                            iID_MaDinhKem = CDinhKem.ThemDinhKem(hangHoa.iID_MaHoSo, hangHoa.iID_MaHangHoa, 51, "0", hangHoa.sMaHoSo, "File bổ sung XNCL Chuyên Viên.", sFileName, "", null, 1, sFileTemp, sUserName, sIP);
                        }
                    }
                }
