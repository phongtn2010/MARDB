...
namespace APP0200025.Controllers
{
    public class PhongTACNYeuCauBoSungKetQuaController : Controller
    {
        ...
        public ActionResult GuiDoanhNghiep(String ParentID)
        {
            ...
            clLichSuHoSo.InsertLichSu(User.Identity.Name, (int)clDoiTuong.DoiTuong.BoPhanMotCua, (int)clHanhDong.HanhDong.GuiDNThongBaoYeuCauBoSungKetQua, "Gửi doanh nghiệp thông báo yêu cầu bổ sung kết quả", "", hoSo.iID_MaTrangThai, trangThaiTiepTheo.iID_MaTrangThai);
          //  XML(18, 21)
