...
namespace APP0200025.Controllers
{
    public class HomeController : Controller
    {
        ...
        public ActionResult MyChart_GDK_Day()
        {
            ...
            List<DateTime> GetDates = CommonFunction.GetDates(iNam, iThang);

            //Tao cột ngày
            for (i = 0; i < GetDates.Count; i++)
            {
                arrChiTieu.Add(GetDates[i].ToString("dd/MM/yyyy"));
            }
            //Tao cột dữ liệu
            for (i = 0; i < GetDates.Count; i++)
            {
                Double iGiaTri = 0;
                iGiaTri = 0;  clHoSo.GetThongKe_BieuDo_Ngay(GetDates[i].ToString("dd/MM/yyyy"));
                arrTG.Add(iGiaTri);
            }
            ...
            Title t = new Title("THỐNG KÊ ĐĂNG KÝ THEO THÁNG", Docking.Top, new System.Drawing.Font("Tahoma , Arial, Helvetica, sans-serif", 10, System.Drawing.FontStyle.Bold), System.Drawing.Color.FromArgb(26, 59, 105));
            Chart2.Titles.Add(t);
