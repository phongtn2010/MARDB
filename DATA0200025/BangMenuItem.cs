                ...
                for (i = 0; i < dt.Rows.Count; i++)
                {
                    ...
                    else
                    {
                        if (tgThuTu % 2 == 0)
                        {
                            ...
                            strPG += string.Format("<td style=\"background-color:#dff0fb;\"><a href=\"\">{1}</a></td>", url, Row["sURL"]);
                        }
                        else
                        {
        ...
        public string LayXauMenuItemCam(string MaLuat, int MaMenuItemCha, int Cap, ref int ThuTu)
        {
            ...
            if (dt.Rows.Count > 0)
            {
                ...
                for (i = 0; i < dt.Rows.Count; i++)
                {
                    ...
                    if (tgThuTu % 2 == 0)
                    {
                        strPG += string.Format("<td style=\"background-color:#dff0fb;\">{1}{0}</td>", Row["sTen"], strDoanTrang);
                    }
                    else
                    {
                        strPG += string.Format("<td>{1}{0}</td>", Row["sTen"], strDoanTrang);
                    }
                    if (tgThuTu % 2 == 0)
                    {
                        strPG += string.Format("<td align=\"center\" style=\"background-color:#dff0fb;\">{0}</td>", strTG);
                    }
                    else
                    {
                        strPG += string.Format("<td align=\"center\">{0}</td>", strTG);
                    }
